...
let hardmat;
    ...
    function _numDecimalNemeth(monEquation) {
    ...
    function _writeform(monEquation) {
        ...
        monEquation.innerHTML = (options.coupureFormule !== 0) && _coupureFormule(monEquation, options.coupureFormule) || monEquation.innerHTML;
    }
