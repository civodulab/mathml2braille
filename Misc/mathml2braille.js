...
(function (w, d, undefined) {
    ...
    function _mfrac(monEquation) {
        ...
        while (mfrac[0]) {
            ...
            console.log(_boolFracComplexity(enfant1, enfant2));
    ...
    function _boolFracComplexity(numerateur, denominateur) {
        var num = numerateur.getElementsByTagName('mfrac'),
            denom = denominateur.getElementsByTagName('mfrac');
        return num.length + '-' + denom.length;
    }
